...
import 'package:tandi_mobile/env/variable/variable_shortcut.dart';
import 'package:tandi_mobile/env/widget/app_expired.dart';
...
class BugCatcher extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //     context.to(child: const LJRExpired());
    //   }
    // });
